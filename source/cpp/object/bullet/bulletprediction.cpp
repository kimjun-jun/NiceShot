...
void UpdateBulletprediction(void)
{
	...
	for (int CntPlayer=0;CntPlayer<PLAYER_MAX;CntPlayer++)
	{
		...
		//float time = 1.0f;
		//float maxtime = 10.0f;
		int nCntBulletpredictionAll = 0;
		for (int nCntBulletpredictionOne = nCntBulletpredictionAll; nCntBulletpredictionOne < 100; nCntBulletpredictionOne++, nCntBulletpredictionAll++)
		{
			//重力と移動量を反映
