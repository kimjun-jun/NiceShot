...
enum OBJECT_MAX
{
	...
	OBJECT_RESULT_MAX = 2,
	OBJECT_TITLE_MAX = 4,
	OBJECT_ALL_MAX = OBJECT_PLAYER_MAX+ OBJECT_CAMERA_MAX +	OBJECT_BULLETPOINT_MAX + OBJECT_TUTORIAL_MAX + OBJECT_STATUS_MAX +
	OBJECT_BULLETPREDICTION_MAX + OBJECT_VITAL_MAX + OBJECT_BULLETGAUGE_MAX + OBJECT_DAMEGE_MAX + OBJECT_EFFECT_MAX + OBJECT_EXPLOSION_MAX + 
	OBJECT_BULLET_MAX +	OBJECT_ITEM_MAX + OBJECT_SHADOW_MAX + OBJECT_COUNTDOWN_MAX + OBJECT_RANK_MAX + OBJECT_RESULT_MAX + OBJECT_TITLE_MAX
};
