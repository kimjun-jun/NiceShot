...
予定　　　ver4.0 2020/12～2021/1　LAN、WAN通信完成。通信専用アイテムミニマップ。簡単なエネミーAI。キーボードマウス操作(検討)。
...
近い目標として2021/1/15までにLAN、WAN通信完成。通信専用アイテムミニマップの実装。簡単なエネミーAIの実装。キーボードマウス操作の実装(検討)。
