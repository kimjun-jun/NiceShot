...
1　4人プレイ時プレイヤー2,3,4が取得したアイテムがプレイヤー1の座標で回収される

2　プレイヤー死亡後、描画を残したままにするのはいいが、地形が変形したときに座標が変更されていない

3　全体的におじゃまアイテムの時間が長い

4　残りの人数で出現するアイテムの確率を変えたほうがいい

5　時間が長引くことがあるため、残り1VS1になったら制限時間を付けるなどの工夫が欲しい

6　大砲の一撃が弱い。戦車なら動きが遅いが攻撃力は高いなどのバランスがあるといいーー＞＞戦車の種類を増やしてスピードタイプ、パワータイプなど好きなタイプを選べてプレイできると面白いかも

7　戦車のスピードを遅くしたほうがいい。早いからジグザグに動くだけで簡単に避けれる。ーー＞＞6と同じ対応したらいいかも
