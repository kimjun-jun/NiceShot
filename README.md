...
ゲーム説明：
四人対戦戦車TPSゲーム。画面分割にてユーザー4人の対戦を実現。(オンライン化を検討中)。フィールドに落ちてるアイテムを駆使して有利に戦おう。
...
本ゲームで実装しないことを決定。代わりに2DゲームのスコアをDB管理、実装予定(FireBaseを使う予定)/2020/09/16
...
タイトルー＞バトルー＞プレイヤー人数選択、チーム選択？ー＞バトルー＞リザルトー＞タイトル
